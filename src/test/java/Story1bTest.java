...
public class Story1bTest
{
    ...
    Booking booking1 = new Booking(1,2, new Date(2020,5,25), new Date(2020,5,27), BookingType.Cabin, 3);
    Booking booking2 = new Booking(2,3, new Date(2020,6,4), new Date(2020,6,7), BookingType.Site, 2);
