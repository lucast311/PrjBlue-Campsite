 ...
 * database.
 */
public class AddGuestWindow extends Stage {
    ...
    public AddGuestWindow(Guest guest)
    {
        ...
        cboPaymentMethod.setValue(PaymentType.Cash);
        ...
        this.setTitle("Add Guest - Cest Campgrounds and Cabins");
        ...
        btnSaveChanges.setOnAction(e -> {
            ...
            {
                //Add dummy guest to arraylist
                guestList.add(obGuestDummy);
